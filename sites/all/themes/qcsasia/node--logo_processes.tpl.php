<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <h2 class="margin-top-0">Logo processes</h3>
    <div class="col-xs-12 padding-0">
        ...
        <div class="col-sm-3">
            <a href="<?= url('photo-etching') ?>" title="Photo etching">
                <div class="thumbnail thumbnail-hover">
                    <img src="<?= url(path_to_theme().'/images/logo-processes/photo-etching.jpg') ?>" alt="Photo etching" title="Photo etching" />
                    <div class="subtitle-pic font-size-13">Photo etching</div>
                </div>
            </a>
        </div>
        <div class="col-sm-3">
            <a href="<?= url('zamac-injection') ?>" title="Zamac injection">
                <div class="thumbnail thumbnail-hover">
                    <img src="<?= url(path_to_theme().'/images/logo-processes/zamac-injection.jpg') ?>" alt="Zamac injection" title="Zamac injection" />
                    <div class="subtitle-pic font-size-13">Zamac injection</div>
                </div>
            </a>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
            <a href="<?= url('2d-soft-pvc') ?>" title="2D soft PVC">
                <div class="thumbnail thumbnail-hover">
                    <img src="<?= url(path_to_theme().'/images/logo-processes/2d-soft-pvc.jpg') ?>" alt="2D soft PVC" title="2D soft PVC" />
                    <div class="subtitle-pic font-size-13">2D soft PVC</div>
                </div>
            </a>
        </div>
        <div class="col-sm-3">
            <a href="<?= url('3d-soft-pvc') ?>" title="3D soft PVC">
                <div class="thumbnail thumbnail-hover">
                    <img src="<?= url(path_to_theme().'/images/logo-processes/3d-soft-pvc.jpg') ?>" alt="3D soft PVC" title="3D soft PVC" />
                    <div class="subtitle-pic font-size-13">3D soft PVC</div>
                </div>
            </a>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
            <a href="<?= url('bar-code-printing') ?>" title="Bar code printing">
                <div class="thumbnail thumbnail-hover">
                    <img src="<?= url(path_to_theme().'/images/logo-processes/bar-code-printing.jpg') ?>" alt="Bar code printing" title="Bar code printing" />
                    <div class="subtitle-pic font-size-13">Bar code printing</div>
                </div>
            </a>
        </div>
    </div>
