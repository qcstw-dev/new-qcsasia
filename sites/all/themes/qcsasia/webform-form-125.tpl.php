...
<div class="catalog-form">
    ...
    <div class="col-xs-12 padding-0">
        <div data-configid="19257370/42684801" style="width:100%; height:855px;" class="issuuembed visible-lg margin-auto"></div>
        <div data-configid="19257370/42684801" style="width:100%; height:680px;" class="issuuembed visible-sm margin-auto"></div>
        <div data-configid="19257370/42684801" style="width:100%; height:307px;" class="issuuembed visible-xs margin-auto"></div>
        <script type="text/javascript" src="//e.issuu.com/embed.js" async="true"></script>
    </div>
    <div class="col-xs-12 padding-0 margin-top-20">
        <?php
        $bIsConnected = isset($_SESSION['user']) && $_SESSION['user']; ?>
        <a <?= (!$bIsConnected ? 'class="disabled_link"' : '') ?> href="<?= (!$bIsConnected ? url('member-area') : url(path_to_theme() . "/images/catalog/QCS ASIA promotional product, gift & souvenir brochure 2017.pdf")) ?>" target="_blank" title="Download Catalog 2016">
            <div class="margin-auto col-xs-4 col-sm-3">
                <div class="thumbnail thumbnail-hover <?= (!$bIsConnected ? 'disabled_link' : '') ?>">
                    <img src="<?= url(path_to_theme() . "/images/catalog/brochure-2017.jpg") ?>" />
